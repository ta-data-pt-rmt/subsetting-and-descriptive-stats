...
In this lab, you will use Pandas library to extract insights from your data by dividing it into several subsets. You might also need to use some Pandas descriptive statistics functions.
